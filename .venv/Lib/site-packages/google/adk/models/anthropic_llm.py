...
def message_to_# removed generation_response(
...
class AnthropicLlm(BaseLlm):
  ...
  async def # removed generation_async(
    ...
    if not stream:
      ...
      yield message_to_# removed generation_response(message)
    else:
      async for response in self._# removed generation_streaming(
          llm_request, messages, tools, tool_choice
      ):
        yield response

  async def _# removed generation_streaming(
      self,
