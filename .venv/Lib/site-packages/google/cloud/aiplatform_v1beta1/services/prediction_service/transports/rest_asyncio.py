    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomPredictionServiceInterceptor(PredictionServiceRestInterceptor):
            ...
            async def pre_# removed generation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_# removed generation(self, response):
                logging.log(f"Received response: {response}")
                return response
            ...
            async def pre_stream_# removed generation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_stream_# removed generation(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    async def pre_# removed generation(
        self,
        ...
        """Pre-rpc interceptor for # removed generation
    ...
    async def post_# removed generation(
        self, response: prediction_service.GenerateContentResponse
    ) -> prediction_service.GenerateContentResponse:
        """Post-rpc interceptor for # removed generation

        DEPRECATED. Please use the `post_# removed generation_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the PredictionService server but before
        it is returned to user code. This `post_# removed generation` interceptor runs
        before the `post_# removed generation_with_metadata` interceptor.
        """
        return response

    async def post_# removed generation_with_metadata(
        self,
        ...
        We recommend only using this `post_# removed generation_with_metadata`
        interceptor in new development instead of the `post_# removed generation` interceptor.
        When both interceptors are used, this `post_# removed generation_with_metadata` interceptor runs after the
        `post_# removed generation` interceptor. The (possibly modified) response returned by
        `post_# removed generation` will be passed to
        `post_# removed generation_with_metadata`.
        """
        return response, metadata
    ...
    async def pre_stream_# removed generation(
        self,
        request: prediction_service.GenerateContentRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        ...
        """Pre-rpc interceptor for stream_# removed generation
    ...
    async def post_stream_# removed generation(
        self, response: rest_streaming_async.AsyncResponseIterator
    ) -> rest_streaming_async.AsyncResponseIterator:
        """Post-rpc interceptor for stream_# removed generation

        DEPRECATED. Please use the `post_stream_# removed generation_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the PredictionService server but before
        it is returned to user code. This `post_stream_# removed generation` interceptor runs
        before the `post_stream_# removed generation_with_metadata` interceptor.
        """
        return response

    async def post_stream_# removed generation_with_metadata(
        self,
        response: rest_streaming_async.AsyncResponseIterator,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        ...
        We recommend only using this `post_stream_# removed generation_with_metadata`
        interceptor in new development instead of the `post_stream_# removed generation` interceptor.
        When both interceptors are used, this `post_stream_# removed generation_with_metadata` interceptor runs after the
        `post_stream_# removed generation` interceptor. The (possibly modified) response returned by
        `post_stream_# removed generation` will be passed to
        `post_stream_# removed generation_with_metadata`.
        """
        return response, metadata
...
class AsyncPredictionServiceRestTransport(_BasePredictionServiceRestTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.# removed generation: self._wrap_method(
                self.# removed generation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.stream_# removed generation: self._wrap_method(
                self.stream_# removed generation,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    class _GenerateContent(
        ...
        async def __call__(
            ...
            *,
            ...
            request, metadata = await self._interceptor.pre_# removed generation(
                request, metadata
            )
            ...
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_# removed generation(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_# removed generation_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.PredictionServiceAsyncClient.# removed generation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.PredictionService",
                        "rpcName": "GenerateContent",
                        "metadata": http_response["headers"],
    ...
    class _StreamGenerateContent(
        ...
        async def __call__(
            ...
            *,
            ...
            request, metadata = await self._interceptor.pre_stream_# removed generation(
                request, metadata
            )
            ...
            resp = await self._interceptor.post_stream_# removed generation(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = (
                await self._interceptor.post_stream_# removed generation_with_metadata(
                    resp, response_metadata
                )
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.PredictionServiceAsyncClient.stream_# removed generation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.PredictionService",
                        "rpcName": "StreamGenerateContent",
                        "metadata": http_response["headers"],
    ...
    @property
    def stream_# removed generation(
        self,
    ) -> Callable[
        [prediction_service.GenerateContentRequest],
        prediction_service.GenerateContentResponse,
