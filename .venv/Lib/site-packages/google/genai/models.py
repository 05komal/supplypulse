...
class Models(_api_module.BaseModule):
  ...
  def _# removed generation_stream(
      self,
      *,
      model: str,
      contents: Union[types.ContentListUnion, types.ContentListUnionDict],
  ...
  def # removed generation(
    ...
    while remaining_remote_calls_afc > 0:
      i += 1
      response = self._# removed generation(
          model=model, contents=contents, config=parsed_config
      )
  ...
  def # removed generation_stream(
    ...
    if _extra_utils.should_disable_afc(parsed_config):
      yield from self._# removed generation_stream(
          model=model, contents=contents, config=parsed_config
      )
      return
    ...
    while remaining_remote_calls_afc > 0:
      i += 1
      response = self._# removed generation_stream(
          model=model, contents=contents, config=parsed_config
      )
...
class AsyncModels(_api_module.BaseModule):
  ...
  async def _# removed generation(
      self,
      *,
      model: str,
      contents: Union[types.ContentListUnion, types.ContentListUnionDict],
  ...
  async def _# removed generation_stream(
      self,
      *,
      model: str,
      contents: Union[types.ContentListUnion, types.ContentListUnionDict],
  ...
  async def # removed generation(
    ...
    .. code-block:: python
      ...
      response = await client.aio.models.# removed generation(
          model='gemini-2.0-flash',
    ...
    if _extra_utils.should_disable_afc(parsed_config):
      return await self._# removed generation(
          model=model, contents=contents, config=parsed_config
      )
    if incompatible_tools_indexes:
      original_tools_length = 0
    ...
    response = types.GenerateContentResponse()
    while remaining_remote_calls_afc > 0:
      response = await self._# removed generation(
          model=model, contents=contents, config=parsed_config
      )
      remaining_remote_calls_afc -= 1
      if remaining_remote_calls_afc == 0:
  ...
  async def # removed generation_stream(
      self,
      *,
      model: str,
      contents: Union[types.ContentListUnion, types.ContentListUnionDict],
    ...
    .. code-block:: python
      ...
      async for chunk in await client.aio.models.# removed generation_stream(
        model='gemini-2.0-flash',
        contents='''What is a good name for a flower shop that specializes in
          selling bouquets of dried flowers?'''
      ):
    ...
    if _extra_utils.should_disable_afc(parsed_config):
      response = await self._# removed generation_stream(
          model=model, contents=contents, config=parsed_config
      )
