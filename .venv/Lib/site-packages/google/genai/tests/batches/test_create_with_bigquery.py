...
_# removed generation_BQ_INPUT_FILE = (
    'bq://vertex-sdk-dev.unified_genai_tests_batches.# removed generation_requests'
)
_# removed generation_BQ_OUTPUT_PREFIX = (
    'bq://vertex-sdk-dev.unified_genai_tests_batches.# removed generation_output'
)
...
test_table: list[pytest_helper.TestTableItem] = [
    pytest_helper.TestTableItem(
        name='test_union_# removed generation_with_bigquery',
        parameters=types._CreateBatchJobParameters(
            model=_GEMINI_MODEL_FULL_NAME,
            src=_# removed generation_BQ_INPUT_FILE,
        ),
    ...
    pytest_helper.TestTableItem(
        name='test_# removed generation_with_bigquery',
        parameters=types._CreateBatchJobParameters(
            model=_GEMINI_MODEL_FULL_NAME,
            src={
                'bigquery_uri': _# removed generation_BQ_INPUT_FILE,
                'format': 'bigquery',
            },
            config={
                'display_name': _DISPLAY_NAME,
                'dest': {
                    'bigquery_uri': _# removed generation_BQ_OUTPUT_PREFIX,
                    'format': 'bigquery',
                },
            },
        ),
...
async def test_async_create(client):
  with pytest_helper.exception_if_mldev(client, ValueError):
    ...
    assert batch_job.src.bigquery_uri == _# removed generation_BQ_INPUT_FILE
