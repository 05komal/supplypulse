...
_# removed generation_GCS_INPUT_FILE = (
    'gs://unified-genai-tests/batches/input/# removed generation_requests.jsonl'
)
_# removed generation_GCS_OUTPUT_PREFIX = 'gs://unified-genai-tests/batches/output'
...
test_table: list[pytest_helper.TestTableItem] = [
    pytest_helper.TestTableItem(
        name='test_union_# removed generation_with_gcs',
        parameters=types._CreateBatchJobParameters(
            model=_GEMINI_MODEL,
            src=_# removed generation_GCS_INPUT_FILE,
        ),
    ...
    pytest_helper.TestTableItem(
        name='test_# removed generation_with_gcs',
        parameters=types._CreateBatchJobParameters(
            model=_GEMINI_MODEL,
            src={
                'gcs_uri': [_# removed generation_GCS_INPUT_FILE],
                'format': 'jsonl',
            },
            config={
                'display_name': _DISPLAY_NAME,
                'dest': {
                    'gcs_uri': _# removed generation_GCS_OUTPUT_PREFIX,
                    'format': 'jsonl',
                },
            },
        ),
...
async def test_async_create(client):
  with pytest_helper.exception_if_mldev(client, ValueError):
    ...
    assert batch_job.src.gcs_uri == [_# removed generation_GCS_INPUT_FILE]
