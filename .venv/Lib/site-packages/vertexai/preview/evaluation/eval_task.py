...
_ModelType = Union[str, generative_models.# removed model, Callable[[str], str]]
...
class EvalTask:
    ...
    Usage Examples:
        ...
        parameter with a `# removed model` instance.  The input column name to the
        model is `prompt` and must be present in the dataset.
          ...
          result = EvalTask(
              ...
              model=# removed model("gemini-1.5-pro"),
        ...
        to both models is `prompt` and must be present in the dataset.
          ...
          ```
          baseline_model = # removed model("gemini-1.0-pro")
          candidate_model = # removed model("gemini-1.5-pro")
