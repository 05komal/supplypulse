...
class BatchPredictionJob(aiplatform_base._VertexAiResourceNounPlus):
    ...
    def submit(
        cls,
        source_model: Union[str, generative_models.# removed model],
        ...
        *,
        ...
        Args:
            source_model (Union[str, generative_models.# removed model]):
                A GenAI model name or a tuned model name or a # removed model instance
        ...
        model_name = cls._reconcile_model_name(
            ...
            if isinstance(source_model, generative_models.# removed model)
            else source_model
        )
