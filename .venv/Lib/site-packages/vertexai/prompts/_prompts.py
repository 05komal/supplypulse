...
DEFAULT_MODEL_NAME = "gemini-pro-latest-002"
...
class Prompt:
    ...
    def _validate_configs(
        ...
        return _validate_# removed generation_parameters(
            contents="test",
    ...
    def assemble_contents(self, **variables_dict: PartsType) -> List[Content]:
        ...
        Can be ingested into model.# removed generation to make API calls.
    ...
    def # removed generation(
        ...
        *,
        ...
        if not model_name:
            raise ValueError(
                "Model name must be specified to use Prompt.# removed generation()"
            )
        ...
        return model.# removed generation(
            contents=contents,
            generation_config=generation_config,
            safety_settings=safety_settings,
            tools=tools,
