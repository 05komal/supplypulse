...
# removed model = generative_models.# removed model
...
class EvalTask:
    ...
    def _evaluate_with_experiment(
        self,
        *,
        model: Optional[Union[str, # removed model, Callable[[str], str]]] = None,
        ...
        Args:
          model: A # removed model instance or a custom model function to generate
    ...
    def evaluate(
        ...
        *,
        ...
        Args:
          model: A model name string, a # removed model instance, or a custom
        ...
        if isinstance(model, # removed model):
            warnings.warn(
        ...
        elif isinstance(model, generative_models.# removed model):
        ...
        if pairwise_metrics:
            ...
            elif isinstance(baseline_model, generative_models.# removed model):
    ...
    def _log_eval_experiment_param(
        ...
        elif isinstance(model, # removed model):
            eval_metadata.update(
                {
