    ...
    async def # removed generation(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_# removed generation():
                # Create a client
                client = aiplatform_v1beta1.PredictionServiceAsyncClient()
                ...
                # Make the request
                response = await client.# removed generation(request=request)
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.# removed generation
        ]
    ...
    def stream_# removed generation(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_stream_# removed generation():
                # Create a client
                client = aiplatform_v1beta1.PredictionServiceAsyncClient()
                ...
                # Make the request
                stream = await client.stream_# removed generation(request=request)
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.stream_# removed generation
        ]
