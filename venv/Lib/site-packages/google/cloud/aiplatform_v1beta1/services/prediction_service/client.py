    ...
    def # removed generation(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_# removed generation():
                # Create a client
                client = aiplatform_v1beta1.PredictionServiceClient()
                ...
                # Make the request
                response = client.# removed generation(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.# removed generation]
    ...
    def stream_# removed generation(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_stream_# removed generation():
                # Create a client
                client = aiplatform_v1beta1.PredictionServiceClient()
                ...
                # Make the request
                stream = client.stream_# removed generation(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.stream_# removed generation]
