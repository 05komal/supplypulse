    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomPredictionServiceInterceptor(PredictionServiceRestInterceptor):
            ...
            def pre_# removed generation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_# removed generation(self, response):
                logging.log(f"Received response: {response}")
                return response
            ...
            def pre_stream_# removed generation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_stream_# removed generation(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    def post_# removed generation_with_metadata(
        self,
    ...
    def pre_stream_# removed generation(
        self,
        request: prediction_service.GenerateContentRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
    ...
    def post_stream_# removed generation(
        self, response: rest_streaming.ResponseIterator
    ) -> rest_streaming.ResponseIterator:
    ...
    def post_stream_# removed generation_with_metadata(
        self,
        response: rest_streaming.ResponseIterator,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
    ...
    class _GenerateContent(
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_# removed generation(
                request, metadata
            )
            ...
            resp = self._interceptor.post_# removed generation(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_# removed generation_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.PredictionServiceClient.# removed generation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.PredictionService",
                        "rpcName": "GenerateContent",
                        "metadata": http_response["headers"],
    ...
    class _StreamGenerateContent(
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_stream_# removed generation(
                request, metadata
            )
            ...
            resp = self._interceptor.post_stream_# removed generation(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_stream_# removed generation_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.PredictionServiceClient.stream_# removed generation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.PredictionService",
                        "rpcName": "StreamGenerateContent",
                        "metadata": http_response["headers"],
