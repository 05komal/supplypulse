        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.PredictionServiceClient.# removed generation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.PredictionService",
                        "rpcName": "GenerateContent",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.PredictionServiceClient.stream_# removed generation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.PredictionService",
                        "rpcName": "StreamGenerateContent",
                        "metadata": http_response["headers"],
