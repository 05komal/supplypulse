        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.PredictionServiceAsyncClient.# removed generation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.PredictionService",
                        "rpcName": "GenerateContent",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.PredictionServiceAsyncClient.stream_# removed generation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.PredictionService",
                        "rpcName": "StreamGenerateContent",
                        "metadata": http_response["headers"],
