...
def _model_response_to_# removed generation_response(
  ...
  llm_response = _message_to_# removed generation_response(
      message,
...
def _message_to_# removed generation_response(
    message: Message,
    *,
...
class LiteLlm(BaseLlm):
  ...
  async def # removed generation_async(
    ...
    if stream:
      ...
      async for part in await self.llm_client.acompletion(**completion_args):
        for chunk, finish_reason in _model_response_to_chunk(part):
          if isinstance(chunk, FunctionChunk):
            ...
            text += chunk.text
            yield _message_to_# removed generation_response(
                ChatCompletionAssistantMessage(
                    role="assistant",
                    content=chunk.text,
                ),
      ...
      yield _model_response_to_# removed generation_response(response)
