...
class LlmResponse(BaseModel):
  ...
  @staticmethod
  def create(
      # removed generation_response: types.GenerateContentResponse,
  ) -> LlmResponse:
    """Creates an LlmResponse from a GenerateContentResponse.

    Args:
      # removed generation_response: The GenerateContentResponse to create the
        LlmResponse from.

    Returns:
      The LlmResponse.
    """
    usage_metadata = # removed generation_response.usage_metadata
    if # removed generation_response.candidates:
      candidate = # removed generation_response.candidates[0]
      if (
        ...
        return LlmResponse(
            ...
            model_version=# removed generation_response.model_version,
        )
      else:
        return LlmResponse(
      ...
      if # removed generation_response.prompt_feedback:
        prompt_feedback = # removed generation_response.prompt_feedback
        return LlmResponse(
