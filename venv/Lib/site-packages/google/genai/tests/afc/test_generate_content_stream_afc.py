...
@pytest.fixture
def mock_# removed generation_stream_no_afc():
  with mock.patch.object(
      models.Models, '_# removed generation_stream'
...
@pytest.fixture
def mock_# removed generation_stream_with_afc():
  with mock.patch.object(
      models.Models, '_# removed generation_stream'
...
@pytest.fixture
def mock_# removed generation_stream_no_afc_async():
  with mock.patch.object(
      models.AsyncModels, '_# removed generation_stream'
  ) as mock_stream_no_afc:
...
@pytest.fixture
def mock_# removed generation_stream_with_afc_async():
  with mock.patch.object(
      models.AsyncModels, '_# removed generation_stream'
  ) as mock_stream_with_afc:
...
def test_# removed generation_stream_no_function_map(
    mock_# removed generation_stream_no_afc,
  ...
  stream = models_instance.# removed generation_stream(
      model='test_model', contents='what is the weather in San Francisco?'
  )
  for chunk in stream:
    assert chunk.text == TEST_NO_AFC_PART.text

  assert mock_# removed generation_stream_no_afc.call_count == 1
  assert mock_get_function_response_parts_none.call_count == 0


def test_# removed generation_stream_afc_disabled(
    mock_# removed generation_stream_with_afc,
    mock_get_function_response_parts_none,
):
  ...
  assert mock_# removed generation_stream_with_afc.call_count == 1
  assert mock_get_function_response_parts_none.call_count == 0


def test_# removed generation_stream_no_function_response(
    mock_# removed generation_stream_no_afc,
    mock_get_function_response_parts_none,
):
...
def test_# removed generation_stream_with_function_tools_used(
    mock_# removed generation_stream_with_afc,
  ...
  assert mock_# removed generation_stream_with_afc.call_count == 2
...
def test_# removed generation_stream_with_thought_summaries(
    mock_# removed generation_stream_with_afc,
    mock_get_function_response_parts,
):
...
@pytest.mark.asyncio
async def test_# removed generation_stream_no_function_map_async(
    mock_# removed generation_stream_no_afc,
    mock_get_function_response_parts_none,
):
  """Test when no function tools are provided.
...
@pytest.mark.asyncio
async def test_# removed generation_stream_afc_disabled_async(
    mock_# removed generation_stream_with_afc_async,
    mock_get_function_response_parts_none,
):
  """Test when function tools are provided but AFC is disabled.
  ...
  stream = await models_instance.# removed generation_stream(
      model='test_model',
      contents='what is the weather in San Francisco?',
      config=types.GenerateContentConfig(
          tools=[get_current_weather],
  ...
  assert mock_# removed generation_stream_with_afc_async.call_count == 1
  assert mock_get_function_response_parts_none.call_count == 0


@pytest.mark.asyncio
async def test_# removed generation_stream_no_function_response_async(
    mock_# removed generation_stream_no_afc_async,
  ...
  assert mock_# removed generation_stream_no_afc_async.call_count == 1

  assert mock_get_function_response_parts_none_async.call_count == 1


@pytest.mark.asyncio
async def test_# removed generation_stream_with_function_tools_used_async(
    mock_# removed generation_stream_with_afc_async,
  ...
  assert mock_# removed generation_stream_with_afc_async.call_count == 2
...
@pytest.mark.asyncio
async def test_# removed generation_stream_with_function_async_function_used_async(
    mock_# removed generation_stream_with_afc_async,
    mock_get_function_response_parts_async,
):
  """Test when function tools are provided and function responses are returned.
...
@pytest.mark.asyncio
async def test_# removed generation_stream_with_thought_summaries_async(
    mock_# removed generation_stream_with_afc_async,
    mock_get_function_response_parts_async,
):
  """Test when function tools are provided and thought summaries are enabled.
