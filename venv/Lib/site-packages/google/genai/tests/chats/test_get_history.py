...
@pytest.fixture
def mock_# removed generation_with_empty_text_part():
  with mock.patch.object(
      models.Models, '# removed generation'
  ) as mock_# removed generation:
    mock_# removed generation.return_value = types.GenerateContentResponse(
        candidates=[
            types.Candidate(
    ...
    yield mock_# removed generation


@pytest.fixture
def mock_# removed generation_empty_content():
  with mock.patch.object(
      models.Models, '# removed generation'
  ) as mock_# removed generation:
    mock_# removed generation.return_value = types.GenerateContentResponse(
...
@pytest.fixture
def mock_# removed generation_stream_with_empty_text_part():
  with mock.patch.object(
      models.Models, '# removed generation_stream'
  ) as mock_# removed generation:
    mock_# removed generation.return_value = [
...
@pytest.fixture
def mock_# removed generation_stream_empty_content():
  with mock.patch.object(
      models.Models, '# removed generation_stream'
  ) as mock_# removed generation:
    mock_# removed generation.return_value = [
...
@pytest.fixture
def mock_# removed generation_afc_history():
  with mock.patch.object(
      models.Models, '# removed generation'
  ) as mock_# removed generation:
    mock_# removed generation.return_value = types.GenerateContentResponse(
...
@pytest.fixture
def mock_# removed generation_stream_afc_history():
  with mock.patch.object(
      models.Models, '# removed generation_stream'
  ) as mock_# removed generation:
    mock_# removed generation.return_value = [
...
def test_chat_with_empty_text_part(mock_# removed generation_with_empty_text_part):
  models_module = models.Models(mock_api_client)
  chats_module = chats.Chats(modules=models_module)
...
def test_chat_with_empty_content(mock_# removed generation_empty_content):
  models_module = models.Models(mock_api_client)
  chats_module = chats.Chats(modules=models_module)
  chat = chats_module.create(model='gemini-2.5-flash')
...
def test_chat_stream_with_empty_text_part(
    mock_# removed generation_stream_with_empty_text_part,
):
  models_module = models.Models(mock_api_client)
  chats_module = chats.Chats(modules=models_module)
  chat = chats_module.create(model='gemini-2.5-flash')
...
def test_chat_stream_with_empty_content(
    mock_# removed generation_stream_empty_content,
):
  models_module = models.Models(mock_api_client)
  chats_module = chats.Chats(modules=models_module)
  chat = chats_module.create(model='gemini-2.5-flash')
...
def test_chat_with_afc_history(mock_# removed generation_afc_history):
  models_module = models.Models(mock_api_client)
  chats_module = chats.Chats(modules=models_module)
  chat = chats_module.create(model='gemini-2.5-flash')
...
def test_chat_stream_with_afc_history(mock_# removed generation_stream_afc_history):
  models_module = models.Models(mock_api_client)
  chats_module = chats.Chats(modules=models_module)
  chat = chats_module.create(model='gemini-2.5-flash')
