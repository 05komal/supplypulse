...
"""Tests for models.# removed generation_stream() with stream_function_call_arguments enabled."""

import pytest
from ... import types
from unittest import mock
from .. import pytest_helper
from . import test_# removed generation_tools
...
previous_# removed generation_history = [
    types.Content(
        role='user',
        parts=[
            types.Part(
...
pytestmark = pytest_helper.setup(
    ...
    test_method='models.# removed generation_stream',
)
...
def test_streaming_with_python_native_no_afc_config(client):
  ...
  with pytest.raises(ValueError) as e:
    for chunk in client.models.# removed generation_stream(
        ...
        contents=# removed generation_prompt,
        config=types.GenerateContentConfig(
            tools=[
                test_# removed generation_tools.get_weather,
                test_# removed generation_tools.get_stock_price,
            ],
...
def test_chat_streaming_with_json_parameters_with_history(client):
  ...
  with pytest_helper.exception_if_mldev(client, ValueError):
    ...
    chat = client.chats.create(
        model='gemini-3-pro-preview',
        history=previous_# removed generation_history,
        config=types.GenerateContentConfig(
            tools=[{
                'function_declarations': gemini_function_declarations
            }],
