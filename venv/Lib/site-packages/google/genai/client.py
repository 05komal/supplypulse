...
class AsyncClient:
  ...
  async def aclose(self) -> None:
    ...
    .. code-block:: python
      ...
      response_1 = await async_client.models.# removed generation(
          model='gemini-2.0-flash',
          contents='Hello World',
      )
      response_2 = await async_client.models.# removed generation(
          model='gemini-2.0-flash',
          contents='Hello World',
      )
...
class Client:
  ...
  def close(self) -> None:
    ...
    .. code-block:: python
      ...
      response_1 = client.models.# removed generation(
          model='gemini-2.0-flash',
          contents='Hello World',
      )
      response_2 = client.models.# removed generation(
          model='gemini-2.0-flash',
          contents='Hello World',
      )
      # Close the client to release resources.
