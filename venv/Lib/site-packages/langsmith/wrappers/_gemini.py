...
def _process_# removed generation_response(response: Any) -> dict:
...
def _reduce_# removed generation_chunks(all_chunks: list) -> dict:
...
def _get_wrapper(
    ...
    """Create a wrapper for Gemini's `# removed generation` methods."""
    ...
    def generate(*args, **kwargs):
        ...
        decorator = run_helpers.traceable(
            name=name,
            run_type="llm",
            reduce_fn=_reduce_# removed generation_chunks if is_streaming else None,
            process_inputs=_process_gemini_inputs,
            process_outputs=(
                _process_# removed generation_response if not is_streaming else None
            ),
...
def wrap_gemini(
    ...
    *,
    ...
    Supports:
        - `# removed generation` and `# removed generation_stream` methods
    ...
    Example:
        ...
        response = client.models.# removed generation(
        ...
        # Streaming:
        for chunk in client.models.# removed generation_stream(
            model="gemini-2.5-flash",
    ...
    if (
        ...
        and hasattr(client.models, "# removed generation")
        and hasattr(client.models.# removed generation, "__wrapped__")
    ):
        raise ValueError(
    ...
    if hasattr(client, "models") and hasattr(client.models, "# removed generation"):
        client.models.# removed generation = _get_wrapper(  # type: ignore[method-assign]
            client.models.# removed generation,
            chat_name,
    ...
    if hasattr(client, "models") and hasattr(client.models, "# removed generation_stream"):
        client.models.# removed generation_stream = _get_wrapper(  # type: ignore[method-assign]
            client.models.# removed generation_stream,
            chat_name,
            prepopulated_invocation_params,
            tracing_extra=tracing_extra_rest,
            is_streaming=True,
    ...
    if (
        ...
        and hasattr(client.aio.models, "# removed generation")
    ):
        client.aio.models.# removed generation = _get_wrapper(  # type: ignore[method-assign]
            client.aio.models.# removed generation,
            chat_name,
            prepopulated_invocation_params,
            tracing_extra=tracing_extra_rest,
            is_streaming=False,
    ...
    if (
        hasattr(client, "aio")
        and hasattr(client.aio, "models")
        and hasattr(client.aio.models, "# removed generation_stream")
    ):
        client.aio.models.# removed generation_stream = _get_wrapper(  # type: ignore[method-assign]
            client.aio.models.# removed generation_stream,
            chat_name,
            prepopulated_invocation_params,
            tracing_extra=tracing_extra_rest,
            is_streaming=True,
