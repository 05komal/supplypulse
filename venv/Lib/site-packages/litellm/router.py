...
class Router:
    ...
    def _initialize_core_endpoints(self):
        ...
        self.a# removed generation = self.factory_function(
            litellm.a# removed generation, call_type="a# removed generation"
        )
        self.aadapter_# removed generation = self.factory_function(
            litellm.aadapter_# removed generation, call_type="aadapter_# removed generation"
        )
    ...
    def _initialize_google_genai_endpoints(self):
        ...
        from litellm.google_genai import (
            a# removed generation,
            a# removed generation_stream,
            # removed generation,
            # removed generation_stream,
        )

        self.a# removed generation = self.factory_function(
            a# removed generation, call_type="a# removed generation"
        )
        self.# removed generation = self.factory_function(
            # removed generation, call_type="# removed generation"
        )
        self.a# removed generation_stream = self.factory_function(
            a# removed generation_stream, call_type="a# removed generation_stream"
        )
        self.# removed generation_stream = self.factory_function(
            # removed generation_stream, call_type="# removed generation_stream"
        )
