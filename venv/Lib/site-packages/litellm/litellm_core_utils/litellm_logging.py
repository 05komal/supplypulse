...
class Logging(LiteLLMLoggingBaseClass):
    ...
    def _success_handler_helper_fn(
        ...
        try:
            ...
            if self.call_type == CallTypes.anthropic_messages.value:
                ...
                self.call_type == CallTypes.# removed generation.value
                or self.call_type == CallTypes.a# removed generation.value
            ):
                result = self._handle_non_streaming_google_genai_# removed generation_response_logging(
                    result=result
                )
            elif (
    ...
    def _handle_non_streaming_google_genai_# removed generation_response_logging(
        self, result: Any
    ) -> ModelResponse:
        """
        ...
        result = litellm.VertexGeminiConfig()._transform_google_# removed generation_to_openai_model_response(
