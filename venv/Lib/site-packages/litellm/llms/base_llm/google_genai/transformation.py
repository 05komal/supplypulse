...
class BaseGoogleGenAIGenerateContentConfig(ABC):
    """Base configuration class for Google GenAI # removed generation functionality"""
    ...
    def get_supported_# removed generation_optional_params(self, model: str) -> List[str]:
        ...
        raise NotImplementedError(
            "get_supported_# removed generation_optional_params is not implemented"
        )
    ...
    def map_# removed generation_optional_params(
        ...
        """
        raise NotImplementedError(
            "map_# removed generation_optional_params is not implemented"
        )
    ...
    def transform_# removed generation_request(
        ...
        Args:
            ...
            tools: Tools
            # removed generation_config_dict: Generation config parameters
