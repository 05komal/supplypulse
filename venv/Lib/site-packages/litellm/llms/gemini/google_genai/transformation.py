...
class GoogleGenAIConfig(BaseGoogleGenAIGenerateContentConfig, VertexLLM):
    ...
    def get_supported_# removed generation_optional_params(self, model: str) -> List[str]:
        """
    ...
    def map_# removed generation_optional_params(
        self,
        # removed generation_config_dict: GenerateContentConfigDict,
        model: str,
    ) -> Dict[str, Any]:
        """
        ...
        Args:
            # removed generation_optional_params: Optional parameters for generate content
            model: The model name
        ...
        _# removed generation_config_dict: Dict[str, Any] = {}
        supported_google_genai_params = (
            self.get_supported_# removed generation_optional_params(model)
        )
        ...
        for param, value in # removed generation_config_dict.items():
            ...
            if is_supported:
                ...
                _# removed generation_config_dict[output_key] = value
        return _# removed generation_config_dict
    ...
    def transform_# removed generation_request(
        self,
        model: str,
        contents: GenerateContentContentListUnionDict,
        tools: Optional[ToolConfigDict],
        # removed generation_config_dict: Dict,
        ...
        typed_# removed generation_request = GenerateContentRequestDict(
            model=model,
            contents=contents,
            tools=tools,
            generationConfig=GenerateContentConfigDict(**# removed generation_config_dict),
        )

        request_dict = cast(dict, typed_# removed generation_request)

        if system_instruction is not None:
            request_dict["systemInstruction"] = system_instruction
        return request_dict

    def transform_# removed generation_response(
        self,
        model: str,
