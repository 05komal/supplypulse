...
class VertexAIGoogleGenAIConfig(GoogleGenAIConfig):
    ...
    def map_# removed generation_optional_params(
        self,
        # removed generation_config_dict,
        model: str,
    ):
        """
    ...
    def transform_# removed generation_request(
        ...
        if # removed generation_config_dict:
            result["generationConfig"] = # removed generation_config_dict
