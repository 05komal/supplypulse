...
def completion(  # noqa: PLR0915
    ...
    try:
        ...
        from vertexai.preview.generative_models import # removed model
        ...
        if (
            ...
            llm_model: Any = _vertex_llm_model_object or # removed model(model)
            mode = "vision"
            request_str += f"llm_model = # removed model({model})\n"
