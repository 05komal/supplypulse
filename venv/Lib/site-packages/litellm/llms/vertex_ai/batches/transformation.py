...
class VertexAIBatchTransformation:
    ...
    def _get_model_from_gcs_file(cls, gcs_file_uri: str) -> str:
        ...
        gcs_file_uri format: gs://litellm-testing-bucket/litellm-vertex-files/publishers/google/models/gemini-pro-latest-001/e9412502-2c91-42a6-8e61-f5c294cc0fc8
        returns: "publishers/google/models/gemini-pro-latest-001"
        """
