...
class BaseLLMHTTPHandler:
    ...
    def # removed generation_handler(
        ...
        model: str,
        contents: Any,
        # removed generation_provider_config: BaseGoogleGenAIGenerateContentConfig,
        ...
        if _is_async:
            return self.async_# removed generation_handler(
                model=model,
                contents=contents,
                # removed generation_provider_config=# removed generation_provider_config,
                # removed generation_config_dict=# removed generation_config_dict,
                tools=tools,
                custom_llm_provider=custom_llm_provider,
                litellm_params=litellm_params,
                logging_obj=logging_obj,
        ...
        (
            headers,
            api_base,
        ) = # removed generation_provider_config.sync_get_auth_token_and_url(
            api_base=litellm_params.api_base,
            model=model,
            litellm_params=dict(litellm_params),
            stream=stream,
        ...
        data = # removed generation_provider_config.transform_# removed generation_request(
            model=model,
            contents=contents,
            tools=tools,
            # removed generation_config_dict=# removed generation_config_dict,
        ...
        try:
            ...
            raise self._handle_error(
                e=e,
                provider_config=# removed generation_provider_config,
            )

        return # removed generation_provider_config.transform_# removed generation_response(
            model=model,
            raw_response=response,
            logging_obj=logging_obj,
        )
    ...
    async def async_# removed generation_handler(
        ...
        (
            headers,
            api_base,
        ) = await # removed generation_provider_config.get_auth_token_and_url(
            model=model,
            litellm_params=dict(litellm_params),
            stream=stream,
            api_base=litellm_params.api_base,
