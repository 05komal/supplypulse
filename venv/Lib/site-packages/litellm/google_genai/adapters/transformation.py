...
class GoogleGenAIStreamWrapper(AdapterCompletionStreamWrapper):
    """
    Wrapper for streaming Google GenAI # removed generation responses.
    ...
    def __next__(self):
        try:
            if not hasattr(self.completion_stream, "__iter__"):
                ...
                return GoogleGenAIAdapter().translate_completion_to_# removed generation(
            ...
            for chunk in self.completion_stream:
                ...
                transformed_chunk = GoogleGenAIAdapter().translate_streaming_completion_to_# removed generation(
                    chunk, self
                )
...
class GoogleGenAIAdapter:
    """Adapter for transforming Google GenAI # removed generation requests to/from litellm.completion format"""

    def __init__(self) -> None:
        pass

    def translate_# removed generation_to_completion(
        self,
        model: str,
        ...
        **kwargs,
        ...
        """
        Transform # removed generation request to litellm completion format
    ...
    def translate_completion_to_# removed generation(
        self,
        response: ModelResponse,
    ) -> Dict[str, Any]:
        """
        Transform litellm completion response to Google GenAI # removed generation format

        Args:
            response: ModelResponse from litellm.completion

        Returns:
            Dict in Google GenAI # removed generation response format
        """
        ...
        # removed generation_response: Dict[str, Any] = {
            "candidates": [
                {
                    "content": {"parts": parts, "role": "model"},
        ...
        if text_content:
            # removed generation_response["text"] = text_content

        return # removed generation_response

    def translate_streaming_completion_to_# removed generation(
        self,
        response: Union[ModelResponse, ModelResponseStream],
        wrapper: GoogleGenAIStreamWrapper,
    ) -> Optional[Dict[str, Any]]:
        """
        Transform streaming litellm completion chunk to Google GenAI # removed generation format
        ...
        Returns:
            Dict in Google GenAI streaming # removed generation response format
        """
