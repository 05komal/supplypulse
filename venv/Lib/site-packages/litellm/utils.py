...
def function_setup(  # noqa: PLR0915
    ...
    try:
        ...
        if (
            ...
            call_type == CallTypes.# removed generation.value
            or call_type == CallTypes.a# removed generation.value
            or call_type == CallTypes.# removed generation_stream.value
            or call_type == CallTypes.a# removed generation_stream.value
        ):
            try:
                ...
                if contents_param:
                    ...
                    transformed = adapter.translate_# removed generation_to_completion(
                        model=model_param,
...
_STREAMING_CALL_TYPES = frozenset(
    {
        CallTypes.# removed generation_stream,
        CallTypes.a# removed generation_stream,
        CallTypes.# removed generation_stream.value,
        CallTypes.a# removed generation_stream.value,
    }
)
...
def _is_streaming_request(
    ...
    Returns True if:
        ...
        - if call_type is # removed generation_stream or a# removed generation_stream (litellm google genai)
    """
...
def _get_model_info_helper(  # noqa: PLR0915
    ...
    try:
        ...
        if custom_llm_provider == "huggingface":
            ...
            3. 'combined_stripped_model_name' in litellm.model_cost. Checks if 'gemini/gemini-pro-latest' in model map, if 'gemini/gemini-pro-latest-001' given.
...
class ProviderConfigManager:
    ...
    @staticmethod
    def get_provider_google_genai_# removed generation_config(
        model: str,
        provider: LlmProviders,
