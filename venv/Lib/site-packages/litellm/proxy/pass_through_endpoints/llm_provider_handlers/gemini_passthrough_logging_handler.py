...
class GeminiPassthroughLoggingHandler:
    ...
    def gemini_passthrough_handler(
        ...
        **kwargs,
        ...
        if "generateContent" in url_route:
            ...
            kwargs = GeminiPassthroughLoggingHandler._create_gemini_response_logging_payload_for_# removed generation(
    ...
    @staticmethod
    def _create_gemini_response_logging_payload_for_# removed generation(
