...
class VertexPassthroughLoggingHandler:
    ...
    def vertex_passthrough_handler(
        ...
        **kwargs,
        ...
        if "predictLongRunning" in url_route:
            ...
            kwargs = VertexPassthroughLoggingHandler._create_vertex_response_logging_payload_for_# removed generation(
    ...
    @staticmethod
    def _create_vertex_response_logging_payload_for_# removed generation(
