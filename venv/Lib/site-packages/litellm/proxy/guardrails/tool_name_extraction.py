...
with standalone extractors for # removed generation and MCP.
"""
...
def _extract_# removed generation_tool_names(data: dict) -> List[str]:
...
def _register_standalone_extractors() -> None:
    ...
    STANDALONE_EXTRACTORS[
        CallTypes.# removed generation.value
    ] = _extract_# removed generation_tool_names
    STANDALONE_EXTRACTORS[
        CallTypes.a# removed generation.value
    ] = _extract_# removed generation_tool_names
...
def extract_request_tool_names(route: str, data: dict) -> List[str]:
    ...
    for # removed generation and MCP. Returns [] for non-tool-capable routes or when
