...
class EvalRunInferenceConfig(_common.BaseModel):
    ...
    # removed generation_config: Optional[genai_types.GenerateContentConfig] = Field(
...
class EvalRunInferenceConfigDict(TypedDict, total=False):
    ...
    # removed generation_config: Optional[genai_types.GenerateContentConfigDict]
...
class Prompt(_common.BaseModel):
    ...
    def assemble_contents(self) -> list[genai_types.Content]:
        ...
        This can be used to call # removed generation() in the Gen AI SDK.
        ...
        genai_client.models.# removed generation(
