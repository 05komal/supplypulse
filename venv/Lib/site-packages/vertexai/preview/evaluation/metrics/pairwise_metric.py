...
class PairwiseMetric(_base._ModelBasedMetric):  # pylint: disable=protected-access
    ...
    Usage Examples:
        ...
        ```
        baseline_model = # removed model("gemini-2.5-pro")
        candidate_model = # removed model("gemini-2.5-flash")
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(baseline_model, generative_models.# removed model):
            _LOGGER.warning(
    ...
    def baseline_model(
        self,
    ) -> Union[generative_models.# removed model, Callable[[str], str]]:
