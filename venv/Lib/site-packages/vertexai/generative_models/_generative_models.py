...
def _validate_# removed generation_parameters(
    ...
    *,
    ...
    """Validates the parameters for a # removed generation call."""
    if not contents:
...
class _# removed model:
    ...
    Usage:
        ...
        ```
        model = # removed model("gemini-pro")
        response = model.# removed generation(
    ...
    def __init__(
        ...
        *,
        ...
        r"""Initializes # removed model.

        Usage:

            ```
            model = # removed model("gemini-pro")
            print(model.# removed generation("Hello"))
            ```

        Args:
            model_name: Model Garden model resource name.
                Alternatively, a tuned model endpoint resource name can be provided.
            generation_config: Default generation config to use in # removed generation.
            safety_settings: Default safety settings to use in # removed generation.
            tools: Default tools to use in # removed generation.
            tool_config: Default tool config to use in # removed generation.
            system_instruction: Default system instruction to use in # removed generation.
        ...
        _validate_# removed generation_parameters(
            contents="test",
    ...
    @overload
    def # removed generation(  # noqa: E704
        self,
        contents: ContentsType,
        *,
        generation_config: Optional[GenerationConfigType] = None,
    ...
    def # removed generation(
        ...
        *,
        ...
        if stream:
            ...
            return self._# removed generation_streaming(
                contents=contents,
                generation_config=generation_config,
                safety_settings=safety_settings,
                tools=tools,
            ...
            return self._# removed generation(
                contents=contents,
                generation_config=generation_config,
                safety_settings=safety_settings,
                tools=tools,
    ...
    @overload
    async def # removed generation_async(  # noqa: E704
        self,
        contents: ContentsType,
        *,
        generation_config: Optional[GenerationConfigType] = None,
    ...
    async def # removed generation_async(
        self,
        contents: ContentsType,
        *,
        generation_config: Optional[GenerationConfigType] = None,
        ...
        """
        if stream:
            return await self._# removed generation_streaming_async(
                contents=contents,
                generation_config=generation_config,
                safety_settings=safety_settings,
                tools=tools,
            ...
            return await self._# removed generation_async(
                contents=contents,
                generation_config=generation_config,
                safety_settings=safety_settings,
                tools=tools,
    ...
    def _# removed generation(
        ...
        *,
        ...
        gapic_response = self._prediction_client.# removed generation(request=request)
        return self._parse_response(gapic_response)

    async def _# removed generation_async(
        self,
        contents: ContentsType,
        *,
        generation_config: Optional[GenerationConfigType] = None,
        ...
        gapic_response = await self._prediction_async_client.# removed generation(
            request=request
        )
        return self._parse_response(gapic_response)

    def _# removed generation_streaming(
        self,
        contents: ContentsType,
        *,
        generation_config: Optional[GenerationConfigType] = None,
        ...
        response_stream = self._prediction_client.stream_# removed generation(
            request=request
        )
        for chunk in response_stream:
            yield self._parse_response(chunk)

    async def _# removed generation_streaming_async(
        self,
        contents: ContentsType,
        *,
        generation_config: Optional[GenerationConfigType] = None,
        ...
        response_stream = await self._prediction_async_client.stream_# removed generation(
            request=request
        )
...
class ChatSession:
    ...
    def _send_message(
        ...
        *,
        ...
        while True:
            ...
            response = self._model._# removed generation(
    ...
    async def _send_message_async(
        ...
        *,
        ...
        response = await self._model._# removed generation_async(
            contents=request_history,
            generation_config=generation_config,
            safety_settings=safety_settings,
            tools=tools,
    ...
    def _send_message_streaming(
        ...
        *,
        ...
        stream = self._model._# removed generation_streaming(
            contents=request_history,
            generation_config=generation_config,
            safety_settings=safety_settings,
            tools=tools,
    ...
    async def _send_message_streaming_async(
        ...
        *,
        ...
        stream = await self._model._# removed generation_streaming_async(
            contents=request_history,
            generation_config=generation_config,
            safety_settings=safety_settings,
            tools=tools,
...
class Tool:
    ...
    Usage:
        ...
        Use tool in `# removed model.# removed generation`:

        ```
        model = # removed model("gemini-pro")
        print(model.# removed generation(
...
class ToolConfig:
    ...
    Usage:
        ...
        Use ToolConfig in `# removed model.# removed generation`:
...
class Content:
    ...
    Usage:
        ...
        ```
        response = model.# removed generation(contents=[
...
class Part:
    ...
    Usage:
        ...
        response1 = model.# removed generation([text_part, image_part])
        response2 = model.# removed generation(video_part)
...
def _to_content(
    ...
    role: str = _# removed model._USER_ROLE,
) -> gapic_content_types.Content:
...
class # removed model(_# removed model):
    __module__ = "vertexai.generative_models"
...
class _Preview# removed model(_# removed model):
    __name__ = "# removed model"
    __module__ = "vertexai.preview.generative_models"
